...
export function DashboardShell({ children, user }: DashboardShellProps) {
    ...
    return (
        <div className="grid h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] overflow-hidden">
            <div className="hidden border-r border-white/10 bg-[hsl(var(--sidebar-background))] text-[hsl(var(--sidebar-foreground))] md:block transition-colors duration-300 overflow-y-auto">
